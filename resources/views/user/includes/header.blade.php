<div class="header w3-hide-small w3-hide-medium">
	<div class="row">
		<div class="col-lg-2">
			<a href="{{URL::to('/user/home')}}"><img src="{{ asset('img/logo_a.png') }}" alt="logo"></a>
		</div>
            <nav class="col-lg-10 navbar navbar-expand-sm justify-content-end">
	            <a href="{{route('cart.view')}}" class="w3-bar-item w3-button w3-hover-khaki w3-right"><span class=" fa fa-store" style="font-size: 20px; margin: 10px;"> Store </span></a>
				<!-- <a href="#" class="w3-bar-item w3-button w3-hover-khaki w3-right"><span class=" fa fa-search" style="font-size: 20px; margin: 10px;"> Search </span></a> -->
			@if (Route::has('login'))
            	@auth
            ...
            @else
	    		@if (Route::has('register'))
	    			<a href="{{ route('register') }}" class="w3-bar-item w3-button w3-hover-khaki w3-right"><span class=" fa fa-sign-in-alt" style="font-size: 20px; margin: 10px;"> Register </span></a>
	    		@endif
	    		<a href="{{ route('login') }}" class="w3-bar-item w3-button w3-hover-khaki w3-right"><span class=" fa fa-registered" style="font-size: 20px; margin: 10px;"> <b>Login</b> </span></a>
            @endauth
        @endif
